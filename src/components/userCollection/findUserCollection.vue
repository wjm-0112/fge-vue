...
<script>
    export default {
        ...
        mounted(){
            this.$http.get("http://localhost:8081/userCollection/findUserCollection?index=1").then(req=>{
                // 给 data 中的 list 赋值
        ...
        methods:{
            changePage:function (index) {
                this.$http.get("http://localhost:8081/userCollection/findUserCollection?index="+index).then(req=>{
